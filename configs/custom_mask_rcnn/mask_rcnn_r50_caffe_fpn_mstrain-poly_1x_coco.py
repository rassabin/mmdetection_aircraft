...
data_root = '/home/maksim/mmdetection/data/coco/'
classes = ('vale', 'chipped', 'bend', 'NIck', 'DIstortion', 'Missing material', 'Bird strike', 'Blend', 'Blend repair', 'Tip curl', 'Scratch')
data = dict(
    imgs_per_gpu=1,
    workers_per_gpu=1,
