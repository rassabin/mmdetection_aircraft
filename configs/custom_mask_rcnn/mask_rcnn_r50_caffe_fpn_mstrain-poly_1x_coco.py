...
# use caffe img_norm
classes = ('vale', 'chipped', 'bend', 'NIck', 'DIstortion', 
'Missing material', 'Bird strike', 'Blend', 'Blend repair', 'Tip curl', 'Scratch')

model = {'type': 'MaskRCNN', 'pretrained': 'torchvision://resnet50' , 
...
'neck': {'type': 'FPN', 'in_channels': [256, 512, 1024, 2048], 
'out_channels': 256, 'num_outs': 5}, 
'rpn_head': {'type': 'RPNHead', 'in_channels': 256, 'feat_channels': 256,
 'anchor_generator': {'type': 'AnchorGenerator', 'scales': [8], 
 ...
 'loss_bbox': {'type': 'L1Loss', 'loss_weight': 1.0}},
  'roi_head': {'type': 'StandardRoIHead', 'bbox_roi_extractor': 
  {'type': 'SingleRoIExtractor', 'roi_layer': 
  {'type': 'RoIAlign', 'out_size': 7, 'sample_num': 0}, 
  ...
  'fc_out_channels': 1024,
   'roi_feat_size': 7,
    ...
    'loss_cls': {'type': 'CrossEntropyLoss', 'use_sigmoid': False, 
    'loss_weight': 1.0}, 'loss_bbox': {'type': 'L1Loss', 'loss_weight': 1.0}},
...
train_cfg = {'rpn':
 ...
 'allowed_border': -1, 'pos_weight': -1, 'debug': False},
  'rpn_proposal': {'nms_across_levels': False, 
  'nms_pre': 2000, 'nms_post': 1000, 'max_num': 1000, 'nms_thr': 0.7, 
  'min_bbox_size': 0}, 'rcnn': {'assigner': {'type': 'MaxIoUAssigner',
...
lr_config = {'policy': 'step', 'warmup': 'linear', 'warmup_iters': 500, 
'warmup_ratio': 0.001, 'step': [8, 11]}
